...
ленивые существа. Это целая методология со своими условными **'правилами'** и ее
...
тесты-код-тесты-код-тесты... и т.д. Поэтому я предлагаю вам
потренероваться, а мне дописать библиотеку и затем я выложу исходники на
github, и выложу сюда ссылку, хорошо?) Ну и отлично!
